# Simple Shopping Site Made With React
Simple Shopping Site Built With React, featuring advanced tools like context, state management, router for navigation, and effects for dynamic user interactions. Discover a modern approach to online shopping with enhanced user experience and seamless functionality.

Link to the website → [**Shopping Cart**](https://bahaungor.github.io/shopping_cart/)

![Image of the project](./public/project-image.png)
